        ...
        if(isset($_SESSION['logged'])){
           ...
           echo "<span class='colflex-center'>";
                ...
                echo "<div class='top' style='width: 99%;'><span>New Post</span><span class='rowflex-utility'><a href='#' onclick='fun(this)'";
                              ...
                              echo "<form> <label for='postTitle' id='titleLabel'>Title: </label><input type='text' class='innerbox' id='postTitle'>";
            ...
            foreach($sql as $row){
                ...
                echo "</br><input class='postButton outerbox' type='submit' id='postSubmit' value='Post'>";
