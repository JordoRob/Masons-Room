...
<head lang="en">
    ...
    <script src="forgotPasswordHandler.js"></script>
    <?php
    session_start(); ?>
...
<body>
    ...
    <div id="window" class="outerbox">
        ...
        <?php
        echo ("<nav><a href='/website/home.php'>Home</a>");
        ...
        <div class="search innerbox">Topic:<span class="search innersearch innerbox">file://<a class="desktop"
                    href="/website/home.php">Home</a><a class="desktop" href="/website/forgotPassword.php">/Forgot_Password</a></span>
        </div>
                 ...
                 <div class="top" style="width: 99%;"><span>Fill out the form below! </span><span class="rowflex-utility"><a href="#" onclick="fun(this)"
                    ...
                    <div class="rectangles colflex-left innerbox">
                                    ...
                                    <div class="forgotPassForm">
                                        ...
                                        <input style="margin-left:54px;" id='email1FP' type="text" name="email1" required>
                                        <label for="email2FP"><b>Confirm Email:</b></label>
                                        <input style="margin-left:52px;" id='email2FP' type="text" name="email2" required> <span id="emailErrorFP" style="font-size:22px; color:red; display:none;"></br>Emails don't match</span> <span id="emailTaken" style="font-size:22px; color:red; display:none;"></br>Email has been taken</span>
                                            </br>   
