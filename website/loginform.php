        ...
        <div class="top"><span>Login! </span><span class="rowflex-utility"><a href="#" onclick="loginClose()"
            ...
            <div  class="loginForm">
                <form>
                    ...
                    <button class="loginButton outerbox"  onclick="window.location.href='/website/register.php'">Sign-Up</button>
                    <button style="width: 43%;;" class="loginButton outerbox"  onclick="window.location.href='/website/forgotPassword.php'">Forgot Password</button>
