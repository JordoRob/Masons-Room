...
<body>
    ...
    <div id="window" class="outerbox">
        ...
        <div class="rectangles innerbox" id="main" style="overflow:hidden;">
            ...
            <div style="display: block; height:auto; margin-left: 300px; margin-right: 50px; width: 150%;">
                 ...
                 <div class="top" style="width: 99%;"><span>Fill out the form below! </span><span class="rowflex-utility"><a href="#" onclick="fun(this)"
                    ...
                    <div class="rectangles colflex-left innerbox">
                                    ...
                                    <div class="registerForm">
                                        ...
                                        <input id='username' type="text" name="uName" required> <span id="usernameError" style="font-size:22px; color:red; display:none;"></br>Username Taken D:</span>
                                            </br>
                                        <label for="email1"><b>Email:</b></label>
                                        <input style="margin-left:54px;" id='email1' type="text" name="email1" required>
                                        <label for="email2"><b>Confirm Email:</b></label>
                                        <input style="margin-left:52px;" id='email2' type="text" name="email2" required> <span id="emailError" style="font-size:22px; color:red; display:none;"></br>Emails either don't match or are invalid</span> <span id="emailTaken" style="font-size:22px; color:red; display:none;"></br>Email has been taken</span>
                                            </br>
                                        <label for="password1" ><b>Password:</b></label>
                                        <input style="margin-left:3px;" id='password1' type="password" name="pWord1" required>
                                        <label for="password2"><b>Confirm Password:</b></label>
                                        <input id='password2' type="password" name="pWord2" required> <span id="passwordError" style="display:none;"></br> Passwords don't match</span><span id="passwordStrength" style="display:none;"></br> Password must be at least eight characters and include one capital, one number and one special character. </span>
                                            </br>
                                        <span> Choose a profile pic! Or upload your own.</span>
                                            </br>
